...
class SlickPerformance_OptionsManager
{
    ...
    public function settingsPage()
    {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'slick-performance'));
        }
        ...
        echo ' ';
        _e('Settings', 'slick-performance'); ?></h2>
        ...
        ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'slick-performance')?>"/>
                </p>
            </form>
            ...
            <p>Once the plugin is activated and configured with a valid site code, it will inject a performance management script in the <head> section of your pages.</p>
        </div>
        <?php
}
...
foreach ($choices as $aChoice) {
    ...
    protected function getOptionValueI18nString($optionValue)
    {
        switch ($optionValue) {
            case 'true':
                return __('true', 'slick-performance');
            case 'false':
                return __('false', 'slick-performance');

            case 'Administrator':
                return __('Administrator', 'slick-performance');
            case 'Editor':
                return __('Editor', 'slick-performance');
            case 'Author':
                return __('Author', 'slick-performance');
            case 'Contributor':
                return __('Contributor', 'slick-performance');
            case 'Subscriber':
                return __('Subscriber', 'slick-performance');
            case 'Anyone':
                return __('Anyone', 'slick-performance');
        }
        return $optionValue;
    }
